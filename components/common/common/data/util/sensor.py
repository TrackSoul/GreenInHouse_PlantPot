...
class Sensor:
    ...
    def toJson(self) -> dict:
        ...
        dic["unidad_medida_0"]=self.getUnidadMedida(0)
        dic["unidad_medida_1"]=self.getUnidadMedida(1)
        dic["unidad_medida_2"]=self.getUnidadMedida(2)
        dic["unidad_medida_3"]=self.getUnidadMedida(3)
