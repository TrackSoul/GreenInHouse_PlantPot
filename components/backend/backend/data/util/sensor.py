...
class SensorBackend():
    ...
    def __init__(self, sensor_common: SensorCommon, sensor_electronico: SensorElectronico):
        self.sensor_common = sensor_common
        self.sensor_electronico = sensor_electronico
    ...
    def leerSesnorYCrearRegistroSensor() -> List[RegistroSensorCommon]:
        sensor_electronico.leer_sensor()
