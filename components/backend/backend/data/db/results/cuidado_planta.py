...
class CuidadoPlanta(ModuloBase):
    ...
    def __init__(self, tipo_planta:str, temperatura_minima:float, temperatura_maxima:float, unidad_temperatura:str,
      humedad_ambiente_minima:float, humedad_ambiente_maxima:float, humedad_maceta_minima:float, humedad_maceta_maxima:float, 
      humedad_suelo_minima:float, humedad_suelo_maxima:float, unidad_humedad:str, luz_minima:float, luz_maxima:float, 
      unidad_luz:str, horas_luz_minimas:float, horas_luz_maximas:float, dia_inicio:int, dia_final:float):
        self.id: int
        ...
        self.unidad_temperatura:str = unidad_temperatura,
        ...
        self.unidad_humedad:str = unidad_humedad,
        self.luz_minima: float = luz_minima
        self.luz_maxima: float  = luz_maxima
        self.unidad_luz:str = unidad_luz,
    ...
    def _table_definition(metadata: MetaData) -> Table:
        ...
        return Table(
            ...
            Column('unidad_temperatura', String, nullable=False ),
            ...
            Column('unidad_humedad', String, nullable=False ),
            Column('luz_minima', Float, nullable=False ),
            Column('luz_maxima', Float, nullable=False ),
            Column('unidad_luz', String, nullable=False ),
