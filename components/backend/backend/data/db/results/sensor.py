...
class Sensor(ModuloBase):
    ...
    def _table_definition(metadata: MetaData) -> Table:
        ...
        return Table(
            ...
            Column('direccion_lectura', String(100), nullable=False),
            Column('patilla_0_lectura', Integer, nullable=False),
            ...
            Column('unidad_medida_0', Enum(UnidadMedida), nullable=False),
