...
class RegistroTipoPlantaService():
    ...
    def createRegistroTipoPlanta(esquema: Esquema, tipo_planta: str, descripcion_planta: str) -> CommonRegistroTipoPlanta:
    ...
    @staticmethod
    def createRegistroTipoPlantaFromCommon(esquema: Esquema, registro_tipo_planta_common: CommonRegistroTipoPlanta) -> CommonRegistroTipoPlanta:
        return RegistroTipoPlantaService.createRegistroTipoPlanta(esquema, registro_tipo_planta_common.getTipoPlanta(), registro_tipo_planta_common.getDescripcionPlanta())

    @staticmethod
    def existsRegistroTipoPlanta(esquema: Esquema, tipo_planta: str) -> bool:
        session: Session = esquema.new_session()
    ...
    @staticmethod
    def listRegistroTipoPlanta(esquema: Esquema) -> List[CommonRegistroTipoPlanta]:
    ...
    @staticmethod
    def getRegistroTipoPlanta(esquema: Esquema, tipo_planta: str) -> CommonRegistroTipoPlanta:
        session : Session = esquema.new_session()
